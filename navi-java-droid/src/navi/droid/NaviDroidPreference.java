...
public class NaviDroidPreference extends PreferenceActivity {
    ...
    public static float getMaxGlobalX() {
        return PreferenceManager.getDefaultSharedPreferences(
                NaviDroidHandler.getMain()).getFloat(MAX_GLOBAL_X, MAX_GLOBAL_X_VAL);
    }

    public static float getMinGlobalX() {
        return PreferenceManager.getDefaultSharedPreferences(
                NaviDroidHandler.getMain()).getFloat(MIN_GLOBAL_X, MIN_GLOBAL_X_VAL);
    }

    public static float getMaxGlobalY() {
        return PreferenceManager.getDefaultSharedPreferences(
                NaviDroidHandler.getMain()).getFloat(MAX_GLOBAL_Y, MAX_GLOBAL_Y_VAL);
    }

    public static float getMinGlobalY() {
        return PreferenceManager.getDefaultSharedPreferences(
                NaviDroidHandler.getMain()).getFloat(MIN_GLOBAL_Y, MIN_GLOBAL_Y_VAL);
    }

    public static int getMaxSpeed() {
        return Integer.parseInt(PreferenceManager.getDefaultSharedPreferences(
                NaviDroidHandler.getMain()).getString(MAX_SPEED, String.valueOf(MAX_SPEED_VAL)));
    }

    public static int getMaxTurningSpeed() {
        return Integer.parseInt(PreferenceManager.getDefaultSharedPreferences(
                NaviDroidHandler.getMain()).getString(MAX_TURNING_SPEED, String.valueOf(MAX_TURNING_SPEED_VAL)));
    }

    public static float getAlpha() {
        return Float.parseFloat(PreferenceManager.getDefaultSharedPreferences(
                NaviDroidHandler.getMain()).getString(ALPHA, String.valueOf(ALPHA_VAL)));
    }

    public static boolean swapSensorOrientation() {
        return PreferenceManager.getDefaultSharedPreferences(
                NaviDroidHandler.getMain()).getBoolean(SWAP_SENSOR_ORIENTATION, SWAP_SENSOR_ORIENTATION_VAL);
    }
}
